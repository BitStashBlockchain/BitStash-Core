...
1. Clone the BitStash Core source code:
    ```shell
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/BitStash"

touch "/Users/${USER}/Library/Application Support/BitStash/bitstash.conf"

chmod 600 "/Users/${USER}/Library/Application Support/BitStash/bitstash.conf"
```

The first time you run bitstashd, it will start downloading the blockchain. This process could
