...
git clone https://github.com/bitstashproject/gitian.sigs.git
```
...
cd /some/root/path/
git clone https://github.com/bitstashproject/bitstash-detached-sigs.git
...
[bitstashproject/gitian.sigs](https://github.com/bitstashproject/gitian.sigs/) repository, or if that's not possible create a pull
