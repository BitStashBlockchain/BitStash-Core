...
void BitStashDGP::initDataSchedule(){
    dataSchedule = scheduleDataForBlockNumber(0);
}

bool BitStashDGP::checkLimitSchedule(const std::vector<uint32_t>& defaultData, const std::vector<uint32_t>& checkData, int blockHeight){
...
dev::eth::EVMSchedule BitStashDGP::getGasSchedule(int blockHeight){
    clear();
...
dev::eth::EVMSchedule BitStashDGP::createEVMSchedule(const dev::eth::EVMSchedule &_schedule, int blockHeight){
