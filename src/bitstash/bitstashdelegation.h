#ifndef BITSTASHDELEGATION_H
#define BITSTASHDELEGATION_H
#include <string>
#include <vector>
#include <map>
#include <stdint.h>
...
/**
 * @brief The IBitStashStaker class Delegation filter
 */
...
/**
 * @brief The BitStashDelegation class Communicate with the bitstash delegation contract
 */
class BitStashDelegation {
    
public:
    /**
     * @brief BitStashDelegation Constructor
     */
    BitStashDelegation();

    /**
     * @brief ~BitStashDelegation Destructor
     */
    virtual ~BitStashDelegation();
...
private:
    BitStashDelegation(const BitStashDelegation&);
    BitStashDelegation& operator=(const BitStashDelegation&);
    BitStashDelegationPriv* priv;
};
#endif
