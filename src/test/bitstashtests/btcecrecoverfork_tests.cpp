...
//    initState();
    ...
    std::vector<BitStashTransaction> txBtcEcrecover;
    txBtcEcrecover.push_back(createBitStashTransaction(CODE[1], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBitStashTransaction(CODE[2], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBitStashTransaction(CODE[3], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
    txBtcEcrecover.push_back(createBitStashTransaction(CODE[4], 0, GASLIMIT, dev::u256(1), ++hashTx, proxy));
