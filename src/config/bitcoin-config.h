...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitStash Core Developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitStash Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitstashco/BitStash-Core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitStash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitStash Core 0.19.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitstash"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitstash.co//"
