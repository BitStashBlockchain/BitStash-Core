...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    //throw std::runtime_error(strprintf("%u \n", txNew.vin[0].scriptSig.size()));
    ...
    genesis.hashStateRoot = uint256(h256Touint(dev::h256("e965ffd002cd6ad0e2dc402b8044de833e06b23127ea8c3d80aec91410771495"))); // stash
    genesis.hashUTXORoot = uint256(h256Touint(dev::sha3(dev::rlp("")))); // stash
    return genesis;
}
...
{
    const char* pszTimestamp = "Forked Qtum which has security of Bitcoin + smart contracts of Ethereum in blockchain";
...
static void MineGenesis(CBlockHeader& genesisBlock, const uint256& powLimit, bool noProduction)
{
    ...
    throw std::runtime_error(strprintf("%u \n %u \n %08x\n %s \n %s \n %s \n", genesisBlock.nTime, genesisBlock.nNonce, genesisBlock.nBits, newhash.ToString().c_str(), genesisBlock.hashStateRoot.ToString().c_str(), genesisBlock.hashMerkleRoot.ToString().c_str()));	
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 985500; // stash halving every 4 years
        consensus.BIP16Exception = uint256S("0x0000f3420c8788eab2b80f8821a8bd8b17de1eafd34baec8ddd0066004a685ac");
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x0000f3420c8788eab2b80f8821a8bd8b17de1eafd34baec8ddd0066004a685ac");
 	...
 	// The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00"); // stash
        ...
        genesis = CreateGenesisBlock(1601691653, 8216273, 0x1f00ffff, 1, 50.21875 * COIN);
	...
	//throw std::runtime_error(strprintf("%s \n %s \n", consensus.hashGenesisBlock.ToString().c_str(), genesis.hashMerkleRoot.ToString().c_str()));	
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000f3420c8788eab2b80f8821a8bd8b17de1eafd34baec8ddd0066004a685ac"));
        assert(genesis.hashMerkleRoot == uint256S("0x03db43366328095460c0c25d4049be38d4ec38e0f5f406515adc8d39cf6c23d5"));
        ...
        vSeeds.emplace_back("bitstash.mywire.org"); // STASH mainnet
        vSeeds.emplace_back("bitstash2.mywire.org"); // STASH mainnet
        ...
        checkpointData = {
            {
                { 0, uint256S("0000f3420c8788eab2b80f8821a8bd8b17de1eafd34baec8ddd0066004a685ac")},
            }
        };
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 985500; // stash halving every 4 years
        consensus.BIP16Exception = uint256S("0x00003edfbd2faa6ed98115d250082e84ec8c3831d021920e0bb0b824b577ce58");
        consensus.BIP34Height = 0;
        consensus.BIP34Hash = uint256S("0x00003edfbd2faa6ed98115d250082e84ec8c3831d021920e0bb0b824b577ce58");
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000054b076851886f682c5"); // stash
        ...
        genesis = CreateGenesisBlock(1504695029, 8219504, 0x1f00ffff, 1, 50 * COIN);
	
	//if (1)
            //MineGenesis(genesis, consensus.powLimit, false);	
	        
	consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000ea2d6d5ee3ccaf0ab03674b76284e69120328213cbc6b288f5e7320f58a"));
        assert(genesis.hashMerkleRoot == uint256S("0xa33875c522f8f9699094aebe7886017319632e5989cac066ff805b9dbc450c85"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("stash4.dynu.net"); // STASH testnet
        ...
        checkpointData = {
            {
                {0, uint256S("00003edfbd2faa6ed98115d250082e84ec8c3831d021920e0bb0b824b577ce58")},
            }
        };
...
public:
    ...
    : CRegTestParams(args)
    {
        ...
        // STASH have 500 blocks of maturity, increased values for regtest in unit tests in order to correspond with it
...
{
    return dev::eth::Network::bitstashMainNetwork;
}
...
{
    consensus.nSubsidyHalvingInterval = 985500; // BitStash halving every 4 years
    consensus.posLimit = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
