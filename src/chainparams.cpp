...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("42gs75d8653448c98731ee5fffd303c15e71ec2057b77f11ab3601979728cdaff2d68afbba14e4fa0bc44f2072b0b23ef63717f8cdfbe58dcd33f32b6afe98741a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 986152; // bitstash halving every 4 years
        ...
        genesis = CreateGenesisBlock(1599400171, 46434, 0x1f00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000ddb7d69fd03a29a1df1cb7e4f22ed3fc4c51c80a443b99afd6c5fec8c4df"));
        assert(genesis.hashMerkleRoot == uint256S("0xc939e2439da0a5a685d343be96f70b3dea1970f1915b5323f97b756b2e600a21"));
	...
	vSeeds.emplace_back("bitstash2.dynu.net");
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x"); // 421632
        ...
        vSeeds.emplace_back("bitstash.dynu.net"); // BitStash testnet
	vSeeds.emplace_back("bitstash2.dynu.net");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,152);
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.nSubsidyHalvingInterval = 986152;
        consensus.BIP16Exception = uint256S("0x");
        ...
        genesis = CreateGenesisBlock(1599400171, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x47a5ffb4f463f94018f6e218058863a81aaef86fc469c8b9c82bafdd01a379ad"));
        assert(genesis.hashMerkleRoot == uint256S("0xc939e2439da0a5a685d343be96f70b3dea1970f1915b5323f97b756b2e600a21"));
