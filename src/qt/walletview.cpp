...
#include <QPushButton>
#include <QVBoxLayout>
#include <qt/bitstashpushbutton.h>
    ...
    gui(nullptr)
{
    ...
    QPushButton *exportButton = new BitStashPushButton(tr("&Export"), this);
    ...
    BRCTokenPage = new BRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    BRCTokenPage->setClientModel(_clientModel);
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    BRCTokenPage->setModel(_walletModel);
