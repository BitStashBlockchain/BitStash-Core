...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("STASH");
    case mBTC: return QString("mSTASH");
    case uBTC: return QString::fromUtf8("μSTASH (bits)");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Stashs");
    case mBTC: return QString("Milli-Stashs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Stashs (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
