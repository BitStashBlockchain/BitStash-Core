#ifndef BITSTASHVERSIONCHECKER_H
#define BITSTASHVERSIONCHECKER_H

#include <QObject>

#define BITSTASH_RELEASES "https://github.com/bitstashco/BitStash-Core"
...
#endif // BITSTASHVERSIONCHECKER_H
