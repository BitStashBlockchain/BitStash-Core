#ifndef STASHVERSIONCHECKER_H
#define STASHVERSIONCHECKER_H

#include <QObject>

#define STASH_RELEASES "https://github.com/bitstashproject/bitstash/releases"
