    ...
    m_results(1)
{
    ...
    ui->labelAmount->setToolTip(tr("The amount in STASH to send. Default = 0."));
    ui->labelSenderAddress->setToolTip(tr("The bitstash address that will be used as sender."));
