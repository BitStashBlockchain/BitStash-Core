    ...
    QWidget(nullptr, f), curAlignment(0), m_node(node)
{
    ...
    QPixmap logo = PlatformStyle::SingleColorIcon(":/icons/splash", foreground_color).pixmap(QSize(logoImageSize, logoImageSize));
    ...
    pixPaint.drawText(welcomeRect, Qt::AlignRight | Qt::AlignTop, "BitStash-Qt Wallet");
